...
function displayItems(){
    ...
    const ChandelierData= foodItem.filter((item)=>item.category=='Chandelier');
    const PendantData= foodItem.filter((item)=>item.category=='Pendant');
    const TablesData= foodItem.filter((item)=>item.category=='Tables');
    const FramesData= foodItem.filter((item)=>item.category=='Frames');
    const chineseData= foodItem.filter((item)=>item.category=='chinese');
    const southData= foodItem.filter((item)=>item.category=='south indian');
    ChandelierData.map(item=>{
        ...
        Chandelier.appendChild(itemCard);
        
    })


    PendantData.map(item=>{
        var itemCard= document.createElement('div');
        itemCard.setAttribute('id','item-card')
